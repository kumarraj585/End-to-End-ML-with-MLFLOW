...
from mlProject.entity.config_entity import DataTransformationConfig, ModelTrainerConfig, ModelEvaluationConfig
...
class ConfigurationManager:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        ...
        # ensure artifact subfolder exists
        create_directories([config.root_dir])
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(
            ...
            target_column = schema.name,
            mlflow_uri="https://dagshub.com/kumarraj585/End-to-End-ML-with-MLFLOW.mlflow",
